...
const OPTIONS = [
  ...
  { key: 'pr',            label: 'Permanent resident' },
  { key: 'refugee',       label: 'Refugee / protected person' },
];
...
export default function Quiz4Screen({ navigation, route }) {
  ...
  const handleContinue = () => {
    navigation.navigate('Quiz5', { answers: { ...previousAnswers, studentStatus: selected } });
  };
    ...
    <SafeAreaView style={styles.safeArea} edges={['top']}>
      ...
      >
        ...
        <View style={styles.progressRow}>
          <Text style={[text.label, styles.stepText]}>STEP 4 OF 5</Text>
          <Text style={[text.label, styles.stepText]}>80%</Text>
        </View>
        ...
        <Text style={[text.bodyReg, styles.subtitle]}>
          Federal grants and some provincial programs have different rules for domestic vs international students.
        </Text>
